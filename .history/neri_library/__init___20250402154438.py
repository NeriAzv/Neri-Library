...
def nr_select(elemento, method, key):
    """
    ...
    - Exemplo:
        ...
        primeira_option = nr_select(elemento_select, "text", "TEXTO DO PRIMEIRO SELECT")
        primeira_option = nr_select(elemento_select, "value", "VALUE_DO_PRIMEIRO_SELECT")
        primeira_option = nr_select(elemento_select, "index", "0")
...
try: print(f"\n\n{ORANGE}Neri_library imported - {re.sub(r"[^0-9.b]", "", version_line)}{RESET}")
except: pass
create_dirs()