...
def main():
    ...
    try:
        with open(target_file, "r") as file: file_content = file.read().lower()
    ...
    if imports:
        ...
        except KeyboardInterrupt: print(f"\n -> pip install {", ".join(imports)}\n {ORANGE}>>{RESET} Só copiar e colar no terminal. (obs: só identifica as libs que são pertencentes da lib)", end="\r")
