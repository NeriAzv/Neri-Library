    ...
    def initialize_driver(self,
        ...
        if self.selenoid:
            ...
            # Un-chrome
                ...
                # options.add_experimental_option("excludeSwitches", ["enable-automation"])  # Corrected
                ...
                # Initialize driver with advanced configurations
                driver = uc.Chrome(
                    options=options,
                ...
                # Disable sensors
                driver.execute_cdp_cmd('Emulation.setSensorOverrideEnabled', {
                    'enabled': True,
                    'type': 'gyroscope',
