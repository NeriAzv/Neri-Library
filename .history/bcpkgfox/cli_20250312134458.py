...
def main():
    ...
    def animate_rgb_text(text, delay=0.01):
        ...
        hue = 0
        print(f"{ORANGE}>{RESET} Dependências do arquivo {DK_ORANGE}'{target_file}'{RESET} identificadas com sucesso")
        time.sleep(1)
        print(f"\n {ORANGE}PIP:{RESET}")
        time.sleep(0.5)
        while True:
